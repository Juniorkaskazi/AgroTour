...
@section('content')
		...
		<div class="page-title image-title" style="background-image:url(assets/img/tour.jpg);">
			<div class="container">
				...
				<h2>Tour Grid Sidebar</h2>
				<p><a href="#" class="theme-cl">Home</a> | <span>Tour Grid Sidebar</span></p>
				</div>
			</div>
		</div>
		<!-- ======================= End Page Title ===================== -->
						...
						<div class="row mrg-0">
							<div class="tr-single-box short-box">
								...
								<div class="col-sm-9 text-right">
									...
									<div class="btn-group">
										 <a href="tour-grid-sidebar.html" class="btn btn-default tooltips">
											 <i class="ti-flix ti-layout-grid2"></i>
										 </a>
									</div>

									<div class="btn-group">
										 <a href="tour-list-sidebar.html" class="btn btn-default tooltips">
